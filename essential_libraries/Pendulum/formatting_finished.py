...
print("some formatting functions")
...
print(f'cookie string:  {dt1.to_cookie_string()}')
print(f'iso8601 string: {dt1.to_iso8601_string()}')
print(f'rfc822 string:  {dt1.to_rfc822_string()}')
