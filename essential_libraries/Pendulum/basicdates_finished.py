...
# define a new variable 'here_and_now" and set it to the current time in the local timezone using the pendulum library
here_and_now = pendulum.now()
print(f'here and now {here_and_now}')
print(f'here and now timezone {here_and_now.timezone.name}')    
